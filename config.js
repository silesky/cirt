System.config({
  ...
  map: {
    "babeK": "npm:babel-core@5.8.38",
    "babeK-runtime": "npm:babel-runtime@5.8.38",
    ...
    "npm:ambi@2.5.0": {
      "editions": "npm:editions@1.3.1",
      "typechecker": "npm:typechecker@4.3.0"
    },
    "npm:apache-crypt@1.2.0": {
      "unix-crypt-td-js": "npm:unix-crypt-td-js@1.0.0"
    },
    "npm:apache-md5@1.1.1": {
      "crypto": "github:jspm/nodelibs-crypto@0.1.0"
    },
    "npm:asap@2.0.5": {
    ...
    "npm:http-auth@2.4.10": {
      "apache-crypt": "npm:apache-crypt@1.2.0",
      "apache-md5": "npm:apache-md5@1.1.1",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
    ...
    "npm:ignorefs@1.1.1": {
      "editions": "npm:editions@1.3.1",
      "ignorepatterns": "npm:ignorepatterns@1.1.0",
      "path": "github:jspm/nodelibs-path@0.1.0"
    },
    "npm:inherits@2.0.1": {
      "util": "github:jspm/nodelibs-util@0.1.0"
    ...
    "npm:live-server@1.1.0": {
      ...
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "http-auth": "npm:http-auth@2.4.10",
      "https": "github:jspm/nodelibs-https@0.1.0",
    ...
    "npm:scandirectory@2.5.0": {
      "ignorefs": "npm:ignorefs@1.1.1",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "safefs": "npm:safefs@3.2.2",
      "taskgroup": "npm:taskgroup@4.3.1"
    },
    "npm:send@0.14.1": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "debug": "npm:debug@2.2.0",
    ...
    "npm:watchr@2.6.0": {
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "extendr": "npm:extendr@3.2.2",
      "extract-opts": "npm:extract-opts@3.3.1",
      "ignorefs": "npm:ignorefs@1.1.1",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "safefs": "npm:safefs@4.1.0",
      "scandirectory": "npm:scandirectory@2.5.0",
      "taskgroup": "npm:taskgroup@5.0.1",
      "typechecker": "npm:typechecker@4.3.0"
    },
